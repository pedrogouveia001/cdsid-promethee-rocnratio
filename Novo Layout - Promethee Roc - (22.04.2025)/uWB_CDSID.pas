...
with UserSession.ZQuery1 do
  begin
    ...
    aux_email := FieldByName('email').AsString;
  ...
  begin
   ...
   exit;
    ...
    if senha <> edtsenha.Text then begin
...
begin
  ...
  WebApplication.SendFile(
    'C:\inetpub\SU_PXOMO_WF1\Files\Guia Prático do Usuario Promethee Roc 2024.pdf', true,
    'Guia Prático do Usuario Promethee Roc 2024.pdf', 'Guia Prático do Usuario Promethee Roc 2024.pdf');
  LockOnSubmit := false;
  Release;
  { FileArquivo.Refresh;
    Inherited;
