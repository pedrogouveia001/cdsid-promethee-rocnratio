...
begin
  ...
  FileArquivo.SaveToFile('C:\Pedro - CDSID\PROMETHEE\PROMETHEE ROCnRATIO\Promethee Roc 05-04 - Pedro\Promethee Roc 04-04 - Pedro\' + (FileArquivo.Filename));
  TIWAdvWebGridExcelIO1.XLSImport('C:\Pedro - CDSID\PROMETHEE\PROMETHEE ROCnRATIO\Promethee Roc 05-04 - Pedro\Promethee Roc 04-04 - Pedro\' +
      (FileArquivo.Filename));
  ...
  //Setando os elementos dos criterios
   ...
   peso[i-1] := 0;
   simpeso[i-1] := 0;
   prefdir[i-1] := 1 - strtoint(grdImport.CELLS[i, 1]);
   //critcode[i - 1] := idcrit;
   limiarp[i-1] := 0;
   limiarq[i-1] := 0;
   limiarg[i-1] := 0;
