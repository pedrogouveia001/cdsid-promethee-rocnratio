  ...
  begin
    ...
    for i := 1 to Nalt do
      begin
        ...
        Cells[i, 4 + Nalt + 16] := FloatToStr(RoundTo(NetFlowSim[i - 1], -4));
      end;
    end;
...
begin
  ...
  begin
    ...
    for i := 0 to TIWUserSession(WebApplication.Data).Nalt do
    begin
      ...
      begin
        ...
        grdSimulationReport.Cell[i, 2].Text := FloatToStr
          (RoundTo(TIWUserSession(WebApplication.Data).rankchanges[i - 1, 0] / NumCases * 100, -4));
