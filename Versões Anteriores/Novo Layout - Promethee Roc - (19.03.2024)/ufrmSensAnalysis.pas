 ...
 // para  escolha
  ...
  chrtsensitivity.leftAxis.Items.Clear; // limpando os valores dos eixos para não se sobrepor
      ...
      begin
         ...
         grddeviation.Cell[j+1,2].Text := FormatFloat('0.00', TIWUserSession(WebApplication.Data).rankchanges[j, 0] * 100 / Numcases) + '%';
         grddeviation.Cell[j+1,3].Text := FormatFloat('0.00', rankchanges[j, 1] * 100 / Numcases) + '%';


         chrtsensitivity.series[0].AddXY(j, (100*TIWUserSession(WebApplication.Data).RankChanges[j,0]/Numcases),
                FormatFloat('0.00', rankchanges[j, 0] * 100 / Numcases) + '%');

         chrtsensitivity.series[1].AddXY(j, (100*RankChanges[j,1]/Numcases),
                FormatFloat('0.00', rankchanges[j, 1] * 100 / Numcases) + '%');
