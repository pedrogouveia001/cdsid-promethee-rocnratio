...
type
  TGrid = class(TIWGrid);
    ...
    procedure IWTimer2Timer(Sender: TObject);
...
begin
  ...
  begin
    if Sonum(edtNumCases.Text) = false then
      edtNumCases.Text := Copy(edtNumCases.Text, 1, length(edtNumCases.Text)
          - 1)
    else
...
procedure TfrmSensitiveAnalysis.IWTimer2Timer(Sender: TObject);
begin
...
begin
  ...
  TIWUserSession(WebApplication.Data).NumCases := 10000;//StrToInt(edtNumCases.Text);
