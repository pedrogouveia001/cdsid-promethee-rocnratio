object frmSensitiveAnalysis: TfrmSensitiveAnalysis
  ...
  object RgCorpo: TIWRegion
    ...
    object rgnSensAnalysis1: TIWRegion
      ...
      object edtNumCases: TIWEdit
        ...
        SubmitOnAsyncEvent = True
        TabOrder = 9
        OnAsyncKeyPress = edtNumCasesAsyncKeyPress
      ...
      object txtNumCasesNote: TIWText
        ...
        Lines.Strings = (
            ...
            #187' The default mode established 100000 cases to be analyzed. Howe' +
            'ver, you can change this parameter above according to your needs' +
            '.')
        RawText = False
        UseFrame = False
        WantReturns = True
  ...
  object timer2: TIWTimer
    Enabled = False
    Interval = 1000
    OnTimer = IWTimer2Timer
    Left = 616
    Top = 912
  end
end
