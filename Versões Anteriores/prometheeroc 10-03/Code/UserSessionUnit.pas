...
uses
  ...
  ZAbstractConnection, IWCompEdit, IWCompLabel, comobj;
...
type
  ...
  public
    ...
    CritName, RestName, AltName, CritName2, AltName2: array of string;
    excelverif: Boolean;
    NameProblem, nome, id: string;
    ...
    PositiveFlow, NegativeFlow, NetFlow, AdapNetFlow: array of real;
