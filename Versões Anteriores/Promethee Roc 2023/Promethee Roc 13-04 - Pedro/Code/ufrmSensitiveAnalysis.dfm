object frmSensitiveAnalysis: TfrmSensitiveAnalysis
  ...
  object imgBackgroundScreen01: TIWImageFile
    ...
    ImageFile.Filename = 
      'C:\Users\Lucas Borges\Desktop\PROMETHEE_ROC - C'#243'digo-Fonte_LOCAL' +
      'SERV\Code\Files\fundocdsid.png'
    ExplicitWidth = 1291
    ExplicitHeight = 1000
  end
  ...
  object btnSignOutScreen01: TIWButton
    Left = 980
    Top = 19
    Width = 75
    Height = 41
    ...
    Font.Size = 10
    Font.Style = [fsBold]
    FriendlyName = 'btnSignOutScreen01'
    ScriptEvents = <>
    TabOrder = 23
    OnClick = btnSignOutScreen01Click
  end
  ...
  object RgCorpo: TIWRegion
    ...
    object tbctrlSensAnalysis: TIWTabControl
      Left = 1
      Top = 1
      Width = 856
      Height = 770
      ...
      DesignSize = (
        856
        770)
      object tbshtSensAnalysis2: TIWTabPage
        Left = 3
        Top = 32
        Width = 856
        Height = 750
        ...
        BorderOptions.Color = clNone
        Color = clWebWHITE
        object tbctrlSensitiveReport: TIWTabControl
          Left = 0
          Top = 0
          Width = 856
          Height = 750
          ...
          DesignSize = (
            856
            750)
          object tbshtCorrelation: TIWTabPage
            Left = 0
            Top = 21
            Width = 856
            Height = 730
          ...
          object tbshtSimulationAnalysis: TIWTabPage
            Left = 0
            Top = 21
            Width = 856
            Height = 730
      ...
      object tbshtSensAnalysis1: TIWTabPage
        AlignWithMargins = True
        Left = 3
        Top = 31
        Width = 853
        ...
        object rgnSensAnalysis1: TIWRegion
          ...
          object lblNumCases: TIWLabel
            ...
            ConvertSpaces = False
            HasTabOrder = False
            FriendlyName = 'lblNumCases'
            Caption = 'Number of cases:'
            RawText = False
          end
          object edtNumCases: TIWEdit
            Left = 131
            Top = 628
            Width = 78
            Height = 21
          ...
          object txtNumCasesNote: TIWText
            Left = 18
            Top = 661
            Width = 368
            Height = 35
            ...
            Lines.Strings = (
                ...
                #187' The defaul mode set 100000 cases to be simulated. However, you' +
                ' can change this parameter above according to your needs.')
            RawText = False
            UseFrame = False
            WantReturns = True
          end
          object rdgrpAnswerQuestConseqMat: TIWRadioGroup
            ...
            Font.Size = 10
            Font.Style = []
            FriendlyName = 'rdgrpAnswerQuestConseqMat'
            ItemIndex = -1
            Items.Strings = (
              'Yes'
              'No')
  ...
  object rgnFooterScreen02: TIWRegion
    Left = 169
    Top = 925
    Width = 886
    Height = 43
    ...
    BorderOptions.Style = cbsSolid
    BorderOptions.Color = clNone
    Color = clWebTransparent
    ParentShowHint = False
    ShowHint = True
    ZIndex = 1000
    Splitter = False
    object txtFooterScreen02: TIWText
      Left = 9
      Top = 4
      Width = 626
      Height = 37
      ...
      Lines.Strings = (
          ...
          'Universidade Federal de Pernambuco (UFPE) | Management Engineeri' +
          'ng Department'
        'Center for Decision Systems and Information Development (CDSID)'
        
          'Technical Support | Phone: (+55) 81  2126.8655 / E-mail: app@cds' +
          'id.org.br')
      RawText = False
      UseFrame = False
      WantReturns = True
    end
    object lblSWCodeScreen02: TIWLabel
      Left = 752
      Top = 12
      Width = 131
      Height = 16
      ...
      HasTabOrder = False
      AutoSize = False
      FriendlyName = 'lblSWCodeScreen02'
