...
begin
  ...
  begin
    ...
    begin
    auxp := strtofloat(edtlimiarp.Text);
    auxi := strtofloat(edtlimiari.Text);
    end;
...
begin
  ...
  begin
    ...
    begin
      TIWUserSession(WebApplication.Data).critsigla[r - 1] := FieldByName
        ('sigla_criterio').AsString;
      TIWUserSession(WebApplication.Data).critname[r - 1] := FieldByName
